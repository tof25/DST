...
En diffusant la fonction \sc{cut\_node()} (voir algo \ref{a:cn}), cette fonction coupe l'étage $st$ du groupe courant à la position $cut\_pos$\footnote{$cut\_pos$ fait partie de la partie coupée}. Puis elle retourne la partie droite si $right$ vaut 1, gauche sinon.\\
