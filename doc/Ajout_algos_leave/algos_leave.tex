...
\newcommand{\algresume}[1]{{\vskip .5cm}\addtocounter{algorithm}{-1}\begin{algorithm}\caption{: (suite)}\begin{algorithmic}[1]\algrestore{#1}\Statex}
...
La fusion n'étant pas possible, il faut réaliser un transfert. (\ldots à continuer \ldots)
