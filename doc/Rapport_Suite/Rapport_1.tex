...
nouveaux n\oe uds pour ne pas courir le risque de trop empiler toutes les demandes. Pour réaliser cela, un
numéro de priorité est attribué à chaque nouveau n\oe ud lors de son arrivée, et cette priorité est prise en
compte de deux fa\c cons : en triant les files {\ti tasks\_queue} selon cet ordre, et lors d'un conflit
