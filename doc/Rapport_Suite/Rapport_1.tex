...
Mais dans les faits, il me semble que la diffusion de {\tt CS\_REQ} échoue bien plus souvent
que celle de {\tt SET\_UPDATE}. On peut donc penser que si ce nouveau mécanisme de {\tt CS\_REQ} n'était pas
utilisé, on aurait beaucoup plus de diffusions de {\tt REMOVE\_STATE}. Il faut encore que je quantifie ces cas
pour vérifier mon intuition. Si elle est juste, alors cette nouvelle solution permet effectivement d'économiser 
