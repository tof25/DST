  ...
  \vspace{0.5cm}\\
	\begin{tabular}{|c|c|c|c|c|c|}
  	\cline{3-6}
		...
		\hline
		\multirow{2}{*}{BR\_CS\_REQ} & Échecs & 292 025 & 343 798 &&\\
		\cline{2-6}                 & Succès & 2 481 & 2 668 &&\\
		\hline
		\multirow{2}{*}{BR\_SET\_UPDATE} & Échecs & 508 & 608 &&\\
		\cline{2-6}                     & Succès & 1 973 & 2 060 &&\\
		\hline
		\multicolumn{2}{|c|}{BR\_REMOVE\_STATE} & 508 & 608 &&\\
		\hline
		\multicolumn{2}{|c|}{Nouveau Contact} & 12 063 & 11 363 &&\\ 
		\hline
	\end{tabular}
