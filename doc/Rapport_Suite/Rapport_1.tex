...
\chapter{Description des fonctions de communication}

\section{Différence entre requêtes synchrones et asynchrones}
...
%
%* Cas d'une requête :
%  Si c'est une demande de connexion ({\tt CNX_REQ}), elle est simplement stockée dans tasks_queue (
...
%
%Cette fonction réalise la même chose que la première partie de send_msg_sync(), à la différence qu'on
...
%  ********
%
%  Si c'est {\tt CNX_REQ}, on l'empile sur tasks_queue, sinon, on l'exécute avec launch_fork_process().
